...
static size_t priority(char op)
{
    switch (op)
    {
...
static void add_infix_op_stack_history(vec_t *hist, str_t *stack)
{
...
static void add_postfix_history(vec_t *hist, vec_t *postfix)
{
...
static bool left_associative_priority_cmp(char op1, char op2)
{
    return priority(op1) >= priority(op2);
}

static bool right_associative_priority_cmp(char op1, char op2)
{
    return priority(op1) > priority(op2);
}
...
static void add_postfix_op_history(str_t *postfix_op_hist, char op)
{
    str_push_back(postfix_op_hist, op);
}

static void add_number_stack_history(vec_t *hist, nums_t *stack)
{
